...
~/.clank/clank/skills/meta/gardening-skills-wiki/check-naming.sh
...
```bash
# 1. Create skill
mkdir -p ~/.clank/clank/skills/category/new-skill
vim ~/.clank/clank/skills/category/new-skill/SKILL.md

# 2. Add to category INDEX
vim ~/.clank/clank/skills/category/INDEX.md
# 3. Run health check
...
```bash
~/.clank/clank/skills/meta/gardening-skills-wiki/garden.sh [skills_dir]
```
