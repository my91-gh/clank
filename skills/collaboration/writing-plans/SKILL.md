...
- if your plan exceeds 20000 words, split into multiple plans with clear dependencies
- track the plans in a master plan document that you update as you create new plans
